...
from getdataset import get_datasetlocal
...
def evaluate_truth_method_long_form(
    ...
    **kwargs,
    ...
    """
    dataset = get_datasetlocal(dataset, size_of_data=size_of_data, seed=seed) #I think this is working just fine
    """
    {'question': "What is the movie 'Call Me By Your Name'?", 'context': ''}
    {'question': 'Can you discuss the tactics utilized in Starbucks\' "Meet Me at Starbucks" marketing campaign?', 'context': ''}
    {'question': 'Can you tell me about Mount Everest?', 'context': ''}"
    """
